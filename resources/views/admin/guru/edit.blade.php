...
@section('title', $guru->nama . ' - Edit Guru')
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.guru.show', $guru) }}"
                                class="text-muted text-hover-primary">{{ $guru->nama }}</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('admin.guru.show', $guru) }}" class="btn btn-sm fw-bold btn-primary">
                        Kembali
                    </a>
                    <!--end::Primary button-->
                </div>
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <select name="jenis_kelamin" id="jenis-kelamin"
                                                    ...
                                                    <option value="L"
                                                        @if (old('jenis_kelamin', $guru->jenis_kelamin) == 'L') selected @endif>Laki-laki</option>
                                                    <option value="P"
