...
@section('title', $jurusan->nama . ' - Edit Jurusan')
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.jurusan.show', $jurusan) }}"
                                class="text-muted text-hover-primary">{{ $jurusan->nama }}</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('admin.jurusan.show', $jurusan) }}" class="btn btn-sm fw-bold btn-primary">
                        Kembali
                    </a>
                    <!--end::Primary button-->
                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-header border-0">
                                    ...
                                    <div class="card-title m-0">
                                        <h3 class="fw-bold m-0">Edit Jurusan</h3>
                                    </div>
                                    <!--end::Card title-->
                                </div>
                                <!--begin::Card header-->
