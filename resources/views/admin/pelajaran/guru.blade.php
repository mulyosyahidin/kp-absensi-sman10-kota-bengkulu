...
@section('title', 'Tambah Guru Pelajaran')
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Tambah Guru</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                    <!--begin::Col-->
                    <div class="col-12">
                        <form action="{{ route('admin.pelajaran.guru.update', $pelajaran) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card">
                                ...
                                <div class="card-header border-0">
                                    ...
                                    <div class="card-title m-0">
                                        <h3 class="fw-bold m-0">Tambah Guru Pelajaran</h3>
                                    </div>
                                    <!--end::Card title-->
                                </div>
                                <!--begin::Card header-->
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <select name="kelas[]" id="kelas"
                                                    class="form-control 2select @error('kelas') is-invalid @enderror"
                                                    multiple>
