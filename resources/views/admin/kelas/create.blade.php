            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Kelas Baru</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                                        ...
                                        <select name="id_jurusan" id="jurusan"
                                            ...
                                            @foreach ($jurusan as $item)
                                                <option value="{{ $item->id }}"
                                                    @if (old('id_jurusan') == $item->id) selected @endif>{{ $item->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <!--end::Input-->
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <select name="tingkat" id="tingkat"
                                                    ...
                                                    <option value="1"
                                                        @if (old('tingkat') == '1') selected @endif>X</option>
                                                    <option value="2"
                                                        @if (old('tingkat') == '2') selected @endif>XI</option>
                                                    <option value="3"
                                                        @if (old('tingkat') == '3') selected @endif>XII</option>
                                                </select>
                                                <!--end::Input-->
