                        ...
                        <div class="col-12 col-md-3">
                            <div class="card card-flush">
                                ...
                                <div class="card-body pt-6">
                                    ...
                                    <br>
                                    {{ $item->kelas->pelajaran->where('guruPelajaran.id_guru', auth()->user()->guru->id)->count() }}
                                    Pelajaran
                                </div>
                                <!--end: Card Body-->
                                <div class="card-footer">
                                    <a href="{{ route('guru.absensi.pelajaran', $item->kelas) }}"
                                        class="btn btn-sm btn-info">Absensi <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    @empty
