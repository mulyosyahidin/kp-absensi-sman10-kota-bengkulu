...
@section('title', 'Absensi Kelas ' . $kelas->nama . ' Pelajaran ' . $pelajaran->nama)
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        Absensi Kelas {{ $kelas->nama }} Pelajaran {{ $pelajaran->nama }}
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Absensi Baru</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('guru.absensi.pelajaran', $kelas->id) }}" class="btn btn-sm fw-bold btn-primary">
                        Kembali
                    </a>
                    <!--end::Primary button-->
                </div>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                    ...
                    <div class="col-12">
                        <form
                            action="{{ route('guru.absensi.store', ['id_kelas' => $kelas->id, 'id_pelajaran' => $pelajaran->id]) }}"
                            method="POST">
                            @csrf
                                ...
                                <div class="card-body pt-6 border-top">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" name="judul"
                                            value="{{ old('judul', 'Absensi Kelas ' . $kelas->nama . ' Pelajaran ' . $pelajaran->nama) }}"
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="number" name="pertemuan_ke"
                                                    value="{{ old('pertemuan_ke', $pertemuan) }}"
