...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        ...
        <a href="{{ route('home') }}">
            ...
            <img alt="Logo" src="{{ asset('assets/images/logo.png') }}" class="h-20px app-sidebar-logo-minimize" />
        </a>
        <!--end::Logo image-->
    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div class="menu-item ">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ activeClass('admin.dashboard') }}" href="{{ route('admin.dashboard') }}">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ activeClass('admin.guru.*') }}" href="{{ route('admin.guru.index') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    ...
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        ...
                                        <rect fill="currentColor" opacity="0.3" x="4" y="5"
                                            width="16" height="6" rx="1.5" />
                                        <rect fill="currentColor" x="4" y="13" width="16"
                                            height="6" rx="1.5" />
                                    </g>
                                </svg>
                                <!--end::Svg Icon-->
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ activeClass('admin.siswa.*') }}" href="{{ route('admin.siswa.index') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo8/dist/../src/media/svg/icons/Layout/Layout-horizontal.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">Data Tambahan</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ activeClass('admin.tahun-ajaran.*') }}"
